...
public class BobaJoint {
    /**
    Declares and initializes all arrays for flavors (size 1000), toppings (size 12), cost (size 1000) and calls input methods. Furthermore, calls 2 orders simulating 2 customers. 
    @param Default
    */
    public static void main(String[] args) throws FileNotFoundException {
        // Array declarations and initialization
        String[] flavors = new String[1000];
        String[] toppings = new String[1000];
        double[] toppingPrice = new double[1000]; 
        // two filler arrays for ordering
        ...
        // hardcode default values for costs array
        ...
        // calling input methods for input
    ...
    */
    public static void order(String[] flavors, String[] toppings, double[] toppingPrice, double[] flavcst, Scanner in, double startcst, String[] itemsAlready, double[] pricesAlready) {
        ...
        // fill in already purchased (purchases from previous orders for the same customer)
        ...
        while(true) {
            ...
            if (ind!=-1) {
                ...
                purchct++;
            } else if (newtopping[0].equals("")) {
                break;
            } else {
                // add new toppings if it was not found
                int i;
                for (i=0;i<toppings.length;i++) {
                    if (toppings[i]==null) {
                        break;
